...
function FooterContent() {
  return (
    <FooterStyle.FooterContainer>
      <div>
        <FooterStyle.FooterLogoContainer>
          <div>
            <FooterStyle.SukoonFooterLogo>
              <StaticImage
                alt="sukoon logo"
      ...
      <FooterStyle.FooterMainContainer>
        <div>
          <FooterStyle.FooterIcon>
            <FooterStyle.IconFlex>
              <FooterStyle.FooterIconPadding>
                <a href="https://www.facebook.com/sukoonhealth/">
                  <svg
              ...
              <FooterStyle.FooterIconPadding>
                <a href="https://twitter.com/sukoonhealth">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    width="16"
              ...
              <FooterStyle.FooterIconPadding>
                <a href="https://in.linkedin.com/company/sukoon-health">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                    width="16"
              ...
              <FooterStyle.FooterIconPadding>
                <a href="https://www.instagram.com/sukoonhealth">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                    width="16"
      ...
      <FooterStyle.FooterCopyRights>
        <p>© 2022 Sukoon health | All rights reserved</p>
      </FooterStyle.FooterCopyRights>
    </FooterStyle.FooterContainer>
  );
}
